...
![img](./img/devops-vs-tradition.jpg)
...
The practice of continuously maintaining code in a deployable state and frequently deploying small code changes to production
